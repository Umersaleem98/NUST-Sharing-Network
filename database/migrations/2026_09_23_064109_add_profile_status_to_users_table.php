...
class AuthController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Suspended and blocked accounts are not allowed to login.
        |--------------------------------------------------------------------------
        */

        $profileStatusMessage =
            $this->getProfileStatusMessage(
                $user
            );
    ...
    */
    ...
    public function verifyEmail(
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | This protects against the account being blocked/suspended
        | while the verification request is processing.
        |--------------------------------------------------------------------------
        */
    ...
    */
    ...
    private function getProfileStatusMessage(
        User $user
    ): ?string {
        if (
            $user->profile_status ===
