                    ...
                    >
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">
                                Create a new student story for the website.
                            </p>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        >
                                            ...
                                            <option
                                                value="image_text"
                                                {{ old('story_type') === 'image_text' ? 'selected' : '' }}
                                            >
                                                Image + Text Story
                                            </option>
                                    ...
                                    >
                                        ...
                                        <textarea
                                            ...
                                            class="form-control"
                                            rows="7"
                                            placeholder="Write student story here..."
                                        >{{ old('story') }}</textarea>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const storyType = document.getElementById('story_type');
